            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center">
                ...
                <Button variant="outline" onClick={shareToTwitter} className="flex items-center text-sm">
                  <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24" width="16" height="16">
                ...
                <Button variant="outline" onClick={shareViaEmail} className="flex items-center text-sm">
                  <svg className="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" width="16" height="16">
